...
.PHONY: ./all
./all: ./Fviewer.exe ./Fviewer.sql ./Makefile
./.cake3/tmp___Fviewer_in_2: ./Fviewer.ur ./Makefile ./autogen/vrungel_mp3.ur ./autogen/vrungel_mp3_c.h ./autogen/vrungel_mp3_c.o ./lib/uru3/Bootstrap/lib.urp ./lib/urweb-monad-pack/lib.urp ./lib/urweb-prelude/lib.urp ./lib/urweb-soup/lib.urp ./lib/urweb-xmlw/lib.urp
	( \
	echo   ;\
	echo \.\/autogen\/vrungel\_mp3  ;\
	echo $$\/list  ;\
	echo $$\/option  ;\
	echo $$\/string  ;\
	echo $$\/char  ;\
	echo \.\/Fviewer  ;\
	) > ./.cake3/tmp___Fviewer_in_2
./.cake3/tmp___Fviewer_in_1: ./Fviewer.ur ./Makefile ./autogen/vrungel_mp3.ur ./autogen/vrungel_mp3_c.h ./autogen/vrungel_mp3_c.o ./lib/uru3/Bootstrap/lib.urp ./lib/urweb-monad-pack/lib.urp ./lib/urweb-prelude/lib.urp ./lib/urweb-soup/lib.urp ./lib/urweb-xmlw/lib.urp
	( \
	echo database\ dbname\=Fviewer  ;\
	echo sql\ \.\/Fviewer\.sql  ;\
	...
	echo allow\ url\ https\:\/\/github\.com\/grwlf\/urweb\-fviewer\*  ;\
	...
	echo ffi\ \.\/autogen\/vrungel\_mp3\_c  ;\
	echo include\ \.\/autogen\/vrungel\_mp3\_c\.h  ;\
	echo link\ \.\/autogen\/vrungel\_mp3\_c\.o  ;\
	echo ffi\ \.\/Audio  ;\
	) > ./.cake3/tmp___Fviewer_in_1
...
.PHONY: ./dropdb
./dropdb: ./Fviewer.db ./Makefile
./Fviewer.db: ./Fviewer.exe ./Fviewer.sql ./Makefile
	dropdb --if-exists Fviewer
	createdb Fviewer
	psql -f ./Fviewer.sql Fviewer
	touch ./Fviewer.db
.INTERMEDIATE: ./.fix-multy1
./.fix-multy1: ./Fviewer.urp ./Makefile $(call GUARD,URWEB) $(call GUARD,UWFLAGS) $(call GUARD,UWINCLUDEDIR) $(call GUARD,UWVER)
	C_INCLUDE_PATH=$(UWINCLUDEDIR) $(URWEB) -dbms postgres $(UWFLAGS) ./Fviewer
./Fviewer.exe: ./.fix-multy1
./Fviewer.sql: ./.fix-multy1
./Fviewer.urp: ./.cake3/tmp___Fviewer_in_1 ./.cake3/tmp___Fviewer_in_2 ./Makefile ./autogen/vrungel_mp3.urp.in
	cat ./.cake3/tmp___Fviewer_in_1 > ./Fviewer.urp
	cat ./autogen/vrungel_mp3.urp.in >> ./Fviewer.urp
	cat ./.cake3/tmp___Fviewer_in_2 >> ./Fviewer.urp
./autogen/vrungel_mp3_c.o: ./Makefile ./autogen/vrungel_mp3_c.c $(call GUARD,UWCC) $(call GUARD,UWINCLUDE)
	$(UWCC) -c -I$(UWINCLUDE) -o ./autogen/vrungel_mp3_c.o ./autogen/vrungel_mp3_c.c
...
.PHONY: ./all
./all: ./.fix-multy1
.PHONY: ./.cake3/tmp___Fviewer_in_2
./.cake3/tmp___Fviewer_in_2: ./.fix-multy1
.PHONY: ./.cake3/tmp___Fviewer_in_1
./.cake3/tmp___Fviewer_in_1: ./.fix-multy1
...
./Fviewer.sql: ./.fix-multy1
.PHONY: ./Fviewer.urp
./Fviewer.urp: ./.fix-multy1
.PHONY: ./autogen/vrungel_mp3_c.o
./autogen/vrungel_mp3_c.o: ./.fix-multy1
